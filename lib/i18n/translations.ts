...
export const translations: Record<"es" | "en", Translations> = {
  es: {
    ...
    exerciseHistory: {
      ...
      comparedToLastWorkout: "Comparado con Último Entrenamiento",
    ...
    restTimer: {
      ...
      restComplete: "¡Descanso Completo!",
      readyForNextSet: "Listo para tu siguiente serie",
      markAndStartNext: "Marcar y Empezar Siguiente",
      markComplete: "Solo Marcar Completado",
      dismiss: "Descartar",
      skip: "Saltar",
      afterSet: "Después de Serie",
      setCompleted: "Serie ya completada",
      viewTimer: "Ver temporizador", 
      cancel: "Cancelar",
      minimize: "Minimizar",
    },
    export: {
      ...
      exportDescription: "Selecciona el formato y las secciones que deseas incluir en tu exportación.",
      selectFormat: "Formato de exportación",
      pdfDesc: "Informe visual con gráficos",
      csvDesc: "Datos tabulares para Excel",
      selected: "Seleccionado",
      sectionsToInclude: "Secciones a incluir",
      sectionsSelected: "seleccionadas",
      overviewSection: "Resumen General",
      overviewSectionDesc: "Días entrenados, descanso, cumplimiento y tiempo",
      volumeChartSection: "Distribución de Volumen",
      volumeChartSectionDesc: "Gráfico de series por grupo muscular",
      exercisePerformanceSection: "Rendimiento de Ejercicios",
      exercisePerformanceSectionDesc: "Tabla detallada de ejercicios realizados",
      weeklyProgressSection: "Progreso Semanal",
      weeklyProgressSectionDesc: "Calendario visual de la semana",
      csvType: "Tipo de exportación CSV",
      cancel: "Cancelar",
  ...
  en: {
    ...
    exerciseHistory: {
      ...
      comparedToLastWorkout: "Compared to Last Workout",
    ...
    restTimer: {
      ...
      readyForNextSet: "Ready for your next set",
      markAndStartNext: "Mark Complete & Start Next",
      markComplete: "Mark Complete Only",
      dismiss: "Dismiss",
      skip: "Skip",
      afterSet: "After Set",
      setCompleted: "Set already completed",
    ...
    export: {
      ...
      exportDescription: "Select the format and sections you want to include in your export.",
      selectFormat: "Export format",
      pdfDesc: "Visual report with charts",
      csvDesc: "Tabular data for Excel",
      selected: "Selected",
      sectionsToInclude: "Sections to include",
      sectionsSelected: "selected",
      overviewSection: "General Overview",
      overviewSectionDesc: "Training days, rest, compliance and time",
      volumeChartSection: "Volume Distribution",
      volumeChartSectionDesc: "Sets chart by muscle group",
      exercisePerformanceSection: "Exercise Performance",
      exercisePerformanceSectionDesc: "Detailed table of exercises performed",
      weeklyProgressSection: "Weekly Progress",
      weeklyProgressSectionDesc: "Visual calendar of the week",
      csvType: "CSV export type",
      cancel: "Cancel",
      exporting: "Exporting...",
      exportNow: "Export",
    },
